...
export const AVAILABILITY = {
  ...
  weekly: {
    // הכותרת של המקטע היא גם ההסבר. קודם היה מעליו כרטיס פתיחה נפרד עם אותו
    // מסר בדיוק ועם כפתור שגלל למקטע שנמצא ישירות מתחתיו — כלומר גלילה מיותרת
    // שרק דחפה את הפעולות אל מחוץ למסך.
    title: "נגדיר מתי העסק פתוח לתורים",
    subtitle:
      "בחרו את הימים והשעות שבהם אפשר לקבוע תורים. תמיד אפשר לשנות את זה בהמשך.",
...
export const BOOKINGS = {
  ...
  actions: {
    ...
    futureHint: "אפשר לסמן שהתור הושלם או שהלקוחה לא הגיעה רק אחרי מועד התור.",
  },
...
export const SETTINGS = {
  ...
  notifications: {
    ...
    unavailableHint: "ההתראות שלך נשלחות בוואטסאפ. שליחת מייל אינה פעילה כרגע.",
    unavailable: "לא פעיל — ההתראות נשלחות בוואטסאפ",
    on: "מופעל",
    off: "כבוי",
  ...
  dataExport: {
    sectionTitle: "הנתונים שלך",
    body: "הנתונים שבמערכת שייכים לך. אפשר להוריד אותם בכל רגע לקובץ אקסל — לגיבוי אישי, לרואה החשבון או פשוט כדי שיהיה לך עותק.",
    clientsButton: "הורדת רשימת הלקוחות",
    clientsHint: "שמות, טלפונים, היסטוריית ביקורים וסטטוס הסכמה להודעות",
    bookingsButton: "הורדת רשימת התורים",
    bookingsHint: "כל התורים — תאריך, שעה, לקוחה, שירות, מחיר וסטטוס",
    deleteTitle: "מחיקת החשבון",
    deleteBody:
      "אפשר לבקש מחיקה מלאה של החשבון וכל הנתונים שבו. המחיקה מתבצעת תוך 30 יום מאימות הבקשה, והיא סופית — כדאי להוריד את הקבצים לפני כן.",
    deleteButton: "בקשת מחיקת חשבון",
  },
...
export const SUBSCRIPTION = {
  ...
  /** תקופת ניסיון חינם — גישה מלאה עם תאריך סיום, ללא חיוב וללא כרטיס אשראי. */
  trial: {
    badge: "תקופת ניסיון",
    priceLabel: "ללא חיוב",
    priceHint: "בתקופת הניסיון",
    endsOn: "הניסיון מסתיים ב־",
    daysLeft: (days: number) =>
      days <= 0
        ? "הניסיון מסתיים היום"
        : days === 1
          ? "נותר יום אחד לתקופת הניסיון"
          : `נותרו ${days} ימים לתקופת הניסיון`,
    note: "כל הכלים פתוחים לך, בלי כרטיס אשראי. בתום התקופה הגישה תיסגר עד להפעלת המנוי.",
    activateButton: "הפעלת המנוי",
    activating: "מעבירים לתשלום…",
    activateHint: (price: number) =>
      `הפעלה עכשיו מתחילה את החיוב החודשי (₪${price} לחודש) מהיום, ומבטלת את יתרת ימי הניסיון.`,
    bannerCta: "להפעלת המנוי",
  },
...
export const ASSISTANT = {
  ...
  answers: {
    ...
    fallbackBody: "אני עדיין לומד. אפשר לנסח אחרת, או לבחור אחת מהשאלות האלה:",
    noAction: "אין פעולה נדרשת כרגע — הכול נראה טוב 👌",
    openLabel: "פתחי",
  },

  // שיחה קלה — ברכות, תודות, ״מי את״, ״עזרה״
  smallTalk: {
    greetingTitle: "היי 👋",
    greetingBody: "טוב לראות אותך! על מה נסתכל היום? אפשר לשאול אותי כל דבר על העסק, או להתחיל מאחת מאלה:",
    thanksTitle: "בשמחה! 🙏",
    thanksBody: "אני כאן מתי שתצטרכי. רוצה שנסתכל על עוד משהו?",
    helpTitle: "אני כאן לעזור",
    helpBody: "אני יודע לענות מתוך הנתונים האמיתיים של העסק שלך. הנה כמה דברים שאפשר לשאול אותי:",
    identityTitle: "נעים להכיר — אני עוזר Allura",
    identityBody:
      "אני עוזר חכם שמבוסס על הנתונים של העסק שלך בלבד — הכול נשאר אצלך, שום דבר לא נשלח החוצה. אני יכול לספר לך על הכנסות, לקוחות בסיכון, חלונות פנויים, מחירים, נאמנות ועוד. נסי לשאול:",
  },
