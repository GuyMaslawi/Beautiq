  ...
  return (
    <div
      ...
      style={{
        ...
        border: open ? "1px solid rgba(184,107,140,0.34)" : "1px solid rgba(184,107,140,0.16)",
        boxShadow: open
      ...
      <div className="relative p-4 md:p-5">
        <div className="flex items-start gap-3.5">
          <span
            ...
            style={{ background: "linear-gradient(135deg,#c97898,#9d6aa8)", boxShadow: "0 8px 18px -6px rgba(184,107,140,0.55)" }}
          >
            {initials}
          </span>
          ...
          {value !== undefined && (
            <div className="shrink-0 rounded-2xl px-3 py-2 text-center" style={{ background: "rgba(247,238,243,0.7)", border: "1px solid rgba(184,107,140,0.2)" }}>
              <div className="display-num text-lg font-bold" style={{ color: "#b86b8c" }} dir="ltr">
                {value}
              </div>
        ...
        {open && expanded && (
          <div className="mt-4 border-t pt-4" style={{ borderColor: "rgba(184,107,140,0.14)" }}>
            {expanded}
          </div>
        )}
      </div>
