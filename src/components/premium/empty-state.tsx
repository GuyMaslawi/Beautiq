...
export function PremiumEmptyState({
  ...
  return (
    ...
    >
      <AuraBlob color="rgba(199,111,147,0.20)" size={260} style={{ top: -90, left: "50%", marginLeft: -130 }} />
      ...
      <div className="relative mx-auto mb-6 flex h-[88px] w-[88px] items-center justify-center">
        ...
        <span
          ...
          style={{ background: tintGradient[tint], boxShadow: "0 12px 28px -8px rgba(172,92,127,0.5)" }}
        >
          {icon ?? <span className="text-2xl" aria-hidden>✦</span>}
        </span>
      </div>

      <h2 className="font-display text-foreground relative text-xl font-semibold tracking-tight">{title}</h2>
