...
/** לקוחות בסיכון — דירוג סיכון רב-שלבי, באנר הכוונה וקריאה לקמפיין החזרה. */
      ...
      {clients.length > 0 && (
        ...
        >
          ...
          <Link
            href={
              summary.critical > 0
                ? "/bring-back?tab=clients&sub=campaigns&campaign=90"
                : summary.high > 0
                  ? "/bring-back?tab=clients&sub=campaigns&campaign=60"
                  : "/bring-back?tab=clients&sub=campaigns"
            }
          >
