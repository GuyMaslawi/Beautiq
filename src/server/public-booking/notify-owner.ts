...
function buildEmailHtml(v: {
  ...
  // כל ערך דינמי עובר escaping: שם הלקוחה והטלפון מגיעים מטופס ציבורי
  ...
  <div style="max-width:480px;margin:0 auto;padding:24px">
    <div style="background:#fff;border-radius:16px;padding:24px;border:1px solid #efe6ec">
      ...
      <p style="margin:0 0 16px;color:#8a7f86;font-size:14px">היי ${escapeHtml(v.ownerName)}, נקבע תור חדש דרך עמוד ההזמנות שלך ב־Allura.</p>
