    ...
    <div className="app-ambient flex min-h-dvh flex-col">
      ...
      <article className="aura-card mx-auto max-w-3xl rounded-3xl px-6 py-10 sm:px-10">
        ...
        <Section title="המנוי והמחיר">
          ...
          <p>
            המחירים נקובים בשקלים חדשים. השירות מופעל על ידי עוסק פטור, ולכן
            לא נגבה מע״מ ולא מתווסף סכום כלשהו למחיר המוצג — עבור כל חיוב תונפק
            לך קבלה. אנו רשאים לעדכן את המחיר מעת לעת; עדכון
