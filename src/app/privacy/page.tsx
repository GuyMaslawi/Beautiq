      ...
      <article className="aura-card mx-auto max-w-3xl rounded-3xl px-6 py-10 sm:px-10">
        ...
        <Section title="שמירת מידע">
          <p>
            ...
            לספק את השירות, לעמוד בדרישות חוקיות או לפתור מחלוקות. פקיעת מנוי
            אינה מוחקת את הנתונים.
          </p>
          <p>
            בעל העסק רשאי לבקש בכל עת את מחיקת החשבון וכל הנתונים שבו, בפנייה
            לכתובת שבתחתית עמוד זה. המחיקה תבוצע בתוך 30 יום ממועד אימות הבקשה,
            בכפוף למידע שאנו מחויבים לשמור על פי דין (למשל תיעוד חיובים לצורכי
            חשבונאות ומס). המחיקה סופית ואינה ניתנת לשחזור.
          </p>
        </Section>
        ...
        <Section title="זכויותיך ויצירת קשר">
          <p>
            ...
            את מחיקתו. את נתוני הלקוחות והתורים שלך אפשר לייצא לקובץ בכל עת,
            ללא צורך בפנייה, מתוך <span className="font-medium">הגדרות → הנתונים
            שלך</span>. בכל שאלה או בקשה אחרת בנוגע לפרטיות תוכל לפנות אלינו
            בכתובת:
          </p>
          <p>
            <a
